<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:108:"E:\wamp64\www\20180305\fan_da\yiyuan\yycc_api\public/../application/admin\view\shoppingmall\add_content.html";i:1522813692;s:97:"E:\wamp64\www\20180305\fan_da\yiyuan\yycc_api\public/../application/admin\view\public\header.html";i:1522737701;s:97:"E:\wamp64\www\20180305\fan_da\yiyuan\yycc_api\public/../application/admin\view\public\footer.html";i:1522636046;}*/ ?>
<!DOCTYPE html>
<!--[if IE 8]>
    ...
    <h3>产品添加</h3>
     <form action="<?php echo url('save_content'); ?>" method="post" enctype="multipart/form-data">
        <div class="form-group">
              <label >产品名称</label>
              <div  >
                  <input type="text" class="form-control" name="chanpin_name">
              </div>
        </div>
        <div class="form-group">
            <label >简介</label>
        ...
        <div class="form-group">
            <label >金额</label>
            <div  >
              <input type="text" class="form-control" name="chanpin_money">
            </div>
        </div>
        <div class="form-group">
            <label >详情内容</label>
            <div  >
              <textarea name="chanpin_info" style="height: 380px;width:700px;"></textarea>
            </div>
        </div>
        <div class="form-group">
              <input type="hidden" name="cread_id" value="<?php echo $cread_id; ?>">
