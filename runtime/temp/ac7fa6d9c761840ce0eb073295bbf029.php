<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:85:"D:\wamp64\www\yiyuanchengcai\fenda\public/../application/admin\view\answer\index.html";i:1507263518;s:86:"D:\wamp64\www\yiyuanchengcai\fenda\public/../application/admin\view\public\header.html";i:1522200620;s:86:"D:\wamp64\www\yiyuanchengcai\fenda\public/../application/admin\view\public\footer.html";i:1510056767;}*/ ?>
<!DOCTYPE html>
<!--[if IE 8]>
                    ...
                    <div class="page-sidebar-wrapper">
                        ...
                        <div class="page-sidebar navbar-collapse collapse">
                            ...
                            <ul class="page-sidebar-menu  page-header-fixed" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
                                ...
                                <li class="nav-item <?php echo  is_active('vpcategory','active');?>
                                   ...
                                   <ul class="sub-menu" style="display: none;">
                                    <li class="nav-item start ">
                                        <a href="/preview/metronic/theme/admin_1/index.html" class="nav-link ">
                                            <i class="icon-bar-chart"></i>
                                            <span class="title">Dashboard 1</span>
                                        </a>
                                    </li>
                                    <li class="nav-item start ">
                                        <a href="/preview/metronic/theme/admin_1/dashboard_2.html" class="nav-link ">
                                            <i class="icon-bulb"></i>
                                    ...
                                    <li class="nav-item start ">
                                        <a href="/preview/metronic/theme/admin_1/dashboard_3.html" class="nav-link ">
                                ...
                                <li class="nav-item <?php echo  is_active('slider','active');?>
                                    ">
                                ...
                                <li class="nav-item <?php echo  is_active('smalltalk','active');?>
                                    ">
                                    <a href="<?php echo url('smalltalk/index'); ?>" class="nav-link nav-toggle">
                                        <i class="icon-disc"></i>
                                        <span class="title">小讲管理</span>
                                    </a>
                                </li>

                                <li class="nav-item <?php echo  is_active('stcate','active');?>
                                    ">
                                    <a href="<?php echo url('stcate/index'); ?>" class="nav-link nav-toggle">
                                        <i class="icon-disc"></i>
                                        <span class="title">小讲分类管理</span>
                                    </a>
                                </li>
...
<div class="mt-3">
    <form class="form-inline" style="margin:20px 0;" action="">
      <div class="form-group">
        <label>答主</label>
        <input type="text" class="form-control" name="real_name" placeholder="Jane Doe" value="<?php echo $real_name; ?>">
      </div>
      <div class="form-group">
        <label>问题编号</label>
        <input type="text" class="form-control" name="quickask_id" placeholder="1" value="<?php echo $quickask_id; ?>">
      </div>
      <div class="form-group">
        <label>采纳</label>
        <select class="form-control" name="is_select">
            <option value="">请选择</option>
            <option value="1" <?php if($is_select=='1'): ?> selected <?php endif; ?>>是</option>
            <option value="0" <?php if($is_select=='0'): ?> selected <?php endif; ?>>否</option>
        </select>
      </div>
    ...
    <table class="table">
        ...
        <?php foreach($answer_list as $value): ?>
        <tr>
            <td><?php echo $value['id']; ?></td>
            <td title="<?php echo $value['quickask_id']; ?>"><?php echo $value['quickask_id']; ?></td>
            <td title="<?php echo $value['real_name']; ?>"><?php echo $value['real_name']; ?></td>
            <td>
            <?php if($value['is_select']==1): ?>
            ✔
            <?php else: ?>
            ✖
            <?php endif; ?>
            </td>
            <td title="<?php echo $value['like_num']; ?>"><?php echo $value['like_num']; ?></td>
            <td title="<?php echo $value['listen_num']; ?>"><?php echo $value['listen_num']; ?></td>
            <td>
