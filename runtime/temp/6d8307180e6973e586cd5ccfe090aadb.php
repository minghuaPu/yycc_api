<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:97:"E:\wamp64\www\20180305\fan_da\yiyuan\yycc_api\public/../application/admin\view\comment\index.html";i:1522636046;s:97:"E:\wamp64\www\20180305\fan_da\yiyuan\yycc_api\public/../application/admin\view\public\header.html";i:1522636046;s:97:"E:\wamp64\www\20180305\fan_da\yiyuan\yycc_api\public/../application/admin\view\public\footer.html";i:1522636046;}*/ ?>
<!DOCTYPE html>
<!--[if IE 8]>
...
<table class="table">
    ...
    <tr>
        ...
        <td><?php echo mb_substr($value['content'],0,7); ?>...</td>
        <td><?php echo mb_substr($value['title'],0,5); ?>...</td>
        <td>
            <a href="<?php echo url('details',['id'=>$value['id']]); ?>" class="btn btn-info">回复</a>
            <a href="<?php echo url('delete',['id'=>$value['id'],'table'=>'comment']); ?>" class="btn btn-danger">删除</a>
        </td>
    </tr>
    <?php endforeach; ?>
</table>
<div><?php echo $comment_list->render(); ?></div>
 <!-- BEGIN FOOTER -->
