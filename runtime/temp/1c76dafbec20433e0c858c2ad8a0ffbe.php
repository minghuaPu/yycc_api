<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:75:"/usr/local/nginx/html/fenda/public/../application/admin/view/vip/index.html";i:1507865140;s:79:"/usr/local/nginx/html/fenda/public/../application/admin/view/public/header.html";i:1510042785;s:79:"/usr/local/nginx/html/fenda/public/../application/admin/view/public/footer.html";i:1510056767;}*/ ?>
<!DOCTYPE html>
<!--[if IE 8]>
...
<div class="mt-3">
    <a href="<?php echo url('add'); ?>" class="btn btn-info">添加答主</a>
    <form class="form-inline" style="margin:20px 0;" action="">
      <div class="form-group">
        <label>姓名</label>
        <input type="text" class="form-control" name="vip_name" placeholder="Jane Doe" value="<?php echo $vip_name; ?>">
      </div>
      <div class="form-group">
        <label>答主分类</label>
        <select class="form-control" name="vip_cate">
            <option value="">请选择</option>
           <?php foreach($vpcate_list as $value): ?>
            <option value="<?php echo $value['id']; ?>" <?php if($value['id']==$vip_cate): ?> selected <?php endif; ?>><?php echo $value['cate_name']; ?></option>
           <?php endforeach; ?>
        </select>
      </div>
      <div class="form-group">
        <label>提问价</label>
        <input type="text" class="form-control" name="floor_price" placeholder="￥0" value="<?php echo $floor_price; ?>">
        ~
        <input type="text" class="form-control" name="ceil_price" placeholder="￥1000" value="<?php echo $ceil_price; ?>">
      </div>
    ...
    <table class="table">
        ...
        <tr>
            ...
            <td title="<?php echo $value['identity']; ?>"><?php echo $value['identity']; ?></td>
            <td title="<?php echo $value['cate_name']; ?>"><?php echo $value['cate_name']; ?></td>
            <td title="<?php echo $value['price']; ?>"><?php echo $value['price']; ?></td>
            <td title="<?php echo $value['sort']; ?>"><?php echo $value['sort']; ?></td>
            <?php if($value['is_real']==2): ?>
            <td>✔</td>
            <?php elseif($value['is_real']==1): ?>
            <td>--</td>
            <?php else: ?>
            <td>✖</td>
            <?php endif; ?>
            <td>
                <?php if($value['is_real']==1): ?>
                <a href="<?php echo url('totrue',['id'=>$value['id']]); ?>" class="btn btn-primary">认证</a>
                <?php endif; ?>
