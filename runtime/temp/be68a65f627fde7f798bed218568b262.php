<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:73:"/usr/local/nginx/html/fenda/public/../application/admin/view/vip/add.html";i:1507126662;s:79:"/usr/local/nginx/html/fenda/public/../application/admin/view/public/header.html";i:1510042785;s:79:"/usr/local/nginx/html/fenda/public/../application/admin/view/public/footer.html";i:1510056767;}*/ ?>
<!DOCTYPE html>
<!--[if IE 8]>
...
<div class="self-container mt-3">
    <h3>答主添加页</h3>
     <form action="<?php echo url('save'); ?>" method="post">
        ...
        <div class="form-group">
            <label >答主分类</label>
            <select name="vip_cate_id" class="form-control">
        ...
        <div class="form-group">
            <label><input name="is_real" type="radio" value="" />认证答主</label> 
            <label><input name="is_real" type="radio" value="" />普通答主</label> 
        </div>  
        <div class="form-group">
            <label >简介</label>
            <textarea id="text_content" name="introduce" style="width:100%"></textarea>
        </div>    
        <div class="form-group">
