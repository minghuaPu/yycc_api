<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:77:"/usr/local/nginx/html/fenda/public/../application/admin/view/myask/index.html";i:1509012182;s:79:"/usr/local/nginx/html/fenda/public/../application/admin/view/public/header.html";i:1507598912;s:79:"/usr/local/nginx/html/fenda/public/../application/admin/view/public/footer.html";i:1501302148;}*/ ?>
<!DOCTYPE html>
<!--[if IE 8]>
...
<div class="mt-3">
    <form class="form-inline" style="margin:20px 0;" action="">
      <div class="form-group">
        <label>提问者</label>
        <input type="text" class="form-control" name="user_name" placeholder="Jane Doe">
      </div>
      <div class="form-group">
        <label>答主</label>
        <input type="text" class="form-control" name="vip_name" placeholder="Jane Doe">
      </div>
      <div class="form-group">
        <label>公开</label>
        <select class="form-control" name="is_public">
            <option value="">请选择</option>
            <option value="1" <?php if($is_public=='1'): ?> selected <?php endif; ?>>是</option>
            <option value="0" <?php if($is_public=='0'): ?> selected <?php endif; ?>>否</option>
        </select>
      </div>
      <!-- <div class="form-group">
        <label>点赞</label>
      ...
      <div class="form-group">
        ...
        <select class="form-control" name="vip_cate">
            <option value="">请选择</option>
            <option value="1">偷听最多</option>
            <option value="0">偷听最少</option>
        </select>
      </div> -->
    ...
    <table class="table">
        ...
        <?php foreach($ask_list as $value): ?>
        <tr>
            <td><?php echo $value['id']; ?></td>
            <td title="<?php echo $value['ask_content']; ?>"><?php echo $value['ask_content']; ?></td>
            ...
            <?php if($value['is_public']==1): ?>
            <td>✔</td>
            <?php else: ?>
            <td>✖</td>
            <?php endif; if($value['status']==1): ?>
            <td>待会答</td>
