<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:89:"D:\wamp64\www\yiyuanchengcai\fenda\public/../application/admin\view\qacategory\index.html";i:1507110847;s:86:"D:\wamp64\www\yiyuanchengcai\fenda\public/../application/admin\view\public\header.html";i:1522205384;s:86:"D:\wamp64\www\yiyuanchengcai\fenda\public/../application/admin\view\public\footer.html";i:1510056767;}*/ ?>
<!DOCTYPE html>
<!--[if IE 8]>
...
<div class="mt-3">
	<a href="<?php echo url('add'); ?>" class="btn btn-info">添加快问分类</a>
    <table class="table">
        <tr>
            <th>编号</th>
            <th>分类名</th>
        ...
        <?php foreach($qacate_list as $value): ?>
        <tr>
            <td><?php echo $value['id']; ?></td>
            <td title="<?php echo $value['cate_name']; ?>"><?php echo $value['cate_name']; ?></td>
            <td title="<?php echo $value['point']; ?>"><?php echo $value['point']; ?></td>
            <td>
