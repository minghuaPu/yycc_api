<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:78:"/usr/local/nginx/html/fenda/public/../application/admin/view/slider/index.html";i:1510041974;s:79:"/usr/local/nginx/html/fenda/public/../application/admin/view/public/header.html";i:1510042785;s:79:"/usr/local/nginx/html/fenda/public/../application/admin/view/public/footer.html";i:1510056767;}*/ ?>
<!DOCTYPE html>
<!--[if IE 8]>
...
<div class="mt-3">
    <a href="<?php echo url('add'); ?>" class="btn btn-info">添加轮播图</a>
    ...
    <table class="table">
        ...
        <?php foreach($slider_list as $value): ?>
        <tr>
            <td><?php echo $value['slider_id']; ?></td>
            <td title="<?php echo $value['slider_img']; ?>"><?php echo $value['slider_img']; ?></td>
            <td><?php echo $value['smalltalk_id']; ?></td>
            <td>
                <a href="<?php echo url('edit',['slider_id'=>$value['slider_id']]); ?>" class="btn btn-info">编辑</a>
                <a href="<?php echo url('delete',['slider_id'=>$value['slider_id']]); ?>" class="btn btn-danger">删除</a>
            </td>
        </tr>
        <?php endforeach; ?>
    </table>
    <div>
     <?php echo $slider_list->render(); ?>
    </div>
    <?php else: ?>
    <p>暂无数据</p>
    <?php endif; ?>
