<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:87:"D:\wamp64\www\yiyuanchengcai\fenda\public/../application/admin\view\headline\index.html";i:1507257632;s:86:"D:\wamp64\www\yiyuanchengcai\fenda\public/../application/admin\view\public\header.html";i:1522205384;s:86:"D:\wamp64\www\yiyuanchengcai\fenda\public/../application/admin\view\public\footer.html";i:1510056767;}*/ ?>
<!DOCTYPE html>
<!--[if IE 8]>
...
<div class="mt-3">
    ...
    <table class="table">
        ...
        <?php foreach($headline_list as $value): ?>
        <tr>
            <td><?php echo $value['id']; ?></td>
            <td title="<?php echo $value['title']; ?>"><?php echo $value['title']; ?></td>
            <td title="<?php echo $value['summary']; ?>"><?php echo $value['summary']; ?></td>
