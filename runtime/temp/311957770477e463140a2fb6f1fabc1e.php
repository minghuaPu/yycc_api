<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:74:"/usr/local/nginx/html/fenda/public/../application/admin/view/user/vip.html";i:1507779384;s:79:"/usr/local/nginx/html/fenda/public/../application/admin/view/public/header.html";i:1510042785;s:79:"/usr/local/nginx/html/fenda/public/../application/admin/view/public/footer.html";i:1510056767;}*/ ?>
<!DOCTYPE html>
<!--[if IE 8]>
...
<div class="self-container mt-3">        
    <h3 style="margin-bottom:20px;">用户-答主信息审核首页</h3>
    <div class="form-group">
        <label>用户ID</label>
        <span><?php echo $user_info['user_id']; ?></span>
    </div>
    <div class="form-group">
        <label>昵称</label>
        <span><?php echo $user_info['real_name']; ?></span>
    </div>
    <div class="form-group">
        <label>领域</label>
        <span><?php echo $user_info['cate_name']; ?></span>
    </div>
    <div class="form-group">
        <label>头衔</label>
        <span><?php echo $user_info['identity']; ?></span>
    </div>
    <div class="form-group">
        <label>简介</label>
        <span><?php echo $user_info['introduce']; ?></span>
    </div>
    <div class="form-group">
        <label>提问价格</label>
        <span><?php echo $user_info['price']; ?></span>
    </div>
    <div class="form-group">
        <a href="<?php echo url('pass',['user_id'=>$user_info['user_id']]); ?>" class="btn btn-info">审核通过</a>
        <a class="btn btn-danger" onclick="$('.info_box').show();">审核不通过</a>
    </div>
    <div class="form-group">
        <form action="<?php echo url('reject',['user_id'=>$user_info['user_id']]); ?>" class="info_box" style="display: none;" method="get">
            <textarea name="reason" rows="10" cols="100" style="resize: none;display: block;"></textarea>
            <input style='display: block;margin-top: 10px;' type="submit" class="btn btn-info" value="提交">
        </form>        
    </div>
</div>
