<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:76:"/usr/local/nginx/html/fenda/public/../application/admin/view/user/index.html";i:1507775907;s:79:"/usr/local/nginx/html/fenda/public/../application/admin/view/public/header.html";i:1510042785;s:79:"/usr/local/nginx/html/fenda/public/../application/admin/view/public/footer.html";i:1510056767;}*/ ?>
<!DOCTYPE html>
<!--[if IE 8]>
...
<div class="mt-3">
    ...
    <form class="form-inline" style="margin:20px 0;" action="">
      ...
      <div class="form-group">
        <label>手机号</label>
        <input type="text" class="form-control" name="phone" placeholder="156" value="<?php echo $phone; ?>">
      </div>
    ...
    <table class="table">
        ...
        <tr>
            ...
            <td title="<?php echo $value['phone']; ?>"><?php echo $value['phone']; ?></td>
            <td title="<?php echo $value['total_income']; ?>"><?php echo $value['total_income']; ?></td>
            <td title="<?php echo $value['total_profit']; ?>"><?php echo $value['total_profit']; ?></td>
            <td>
                <?php if($value['status']==2): ?>
                <a href="<?php echo url('vip',['id'=>$value['id']]); ?>" class="btn btn-primary">开通答主</a>
                <?php endif; ?>
