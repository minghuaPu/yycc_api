<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:97:"E:\wamp64\www\20180305\fan_da\yiyuan\yycc_api\public/../application/admin\view\smalltalk\add.html";i:1522636046;s:97:"E:\wamp64\www\20180305\fan_da\yiyuan\yycc_api\public/../application/admin\view\public\header.html";i:1522737701;s:97:"E:\wamp64\www\20180305\fan_da\yiyuan\yycc_api\public/../application/admin\view\public\footer.html";i:1522636046;}*/ ?>
<!DOCTYPE html>
<!--[if IE 8]>
     ...
     <form action="<?php echo url('save'); ?>" method="post" enctype="multipart/form-data">
      <div class="form-group">
        ...
        <div class="form-group">
            <label >多少人参加</label>
            <div  >
                <input class="form-control" type="text" name="join_num">
            </div>
        </div>
          <div class="form-group">
            <label >简介</label>
        ...
        <div class="form-group">
            <label >缩略图</label>
            <div  >
                <input type="file" name="smalltalk_img">
            </div>
        </div>
           <div class="form-group">
            <label >所属讲师</label>
            <div >
               ...
               <select name="vip_id">
                   ...
                   <?php foreach($vip as $key=>$info): ?>
                   <option value="<?php echo $info['id']; ?>"><?php echo $info['real_name']; ?></option>
                   <?php endforeach; ?>
         ...
         <div class="form-group">
            ...
            <div >
               ...
               <select name="smalltalk_cate_id">
                   <option value="">请选择分类</option>
                  
                   <?php foreach($cate_menu as $key=>$cate): ?>
